...
<html>
  ...
  <body>
    ...
    #     .attr(
    #         "r": radius
    #         "title": (d) -> "<strong>#{d.name__}</strong><br>x: #{decimal_format(d.x)}<br>y: #{decimal_format(d.y)}"
    #         "class": "circle_tooltip"
    #         "transform": transform
    #         "fill": (d) -> color_scale(d.colorize__)
    #     )

    # names = clip.selectAll("text")
    #     .data(data, (d) -> d.name__)
    #   .enter().append("text")
    #     .text((d) -> d.name__)
    #     .attr(
    #         "dy": ".32em"
    ...
    #     .attr("transform","translate(#{plot.width + 15},#{0})")
