...
(function() {
  ...
  this.draw_axes = function(plot) {
    var _ref, _ref1;
    if ((_ref = plot.orientation_x) == null) {
      plot.orientation_x = "bottom";
    }
    if ((_ref1 = plot.orientation_y) == null) {
    ...
    plot.selectAll(".axis line, .axis path").style({
      "fill": "none",
      "stroke": "black",
  ...
  this.draw_axes_labels = function(plot) {
    ...
    plot.append("text").text(plot.xlab).attr({
      "class": "x label",
      "text-anchor": "middle",
