...
test_that("reads the correct data input", {
    ...
    expect_equal(toJSON(data), "[{\"name\":1,\"values\":[{\"x\":1,\"y\":1},{\"x\":2,\"y\":4},{\"x\":3,\"y\":7}]},{\"name\":2,\"values\":[{\"x\":1,\"y\":2},{\"x\":2,\"y\":5},{\"x\":3,\"y\":8}]},{\"name\":3,\"values\":[{\"x\":1,\"y\":3},{\"x\":2,\"y\":6},{\"x\":3,\"y\":9}]}]")
    ...
    expect_equal(toJSON(data), "[{\"name\":\"a\",\"values\":[{\"x\":\"x1\",\"y\":1},{\"x\":\"x2\",\"y\":4},{\"x\":\"x3\",\"y\":7}]},{\"name\":\"b\",\"values\":[{\"x\":\"x1\",\"y\":2},{\"x\":\"x2\",\"y\":5},{\"x\":\"x3\",\"y\":8}]},{\"name\":\"c\",\"values\":[{\"x\":\"x1\",\"y\":3},{\"x\":\"x2\",\"y\":6},{\"x\":\"x3\",\"y\":9}]}]")
