...
(function() {
  var clip, color_legend_counts, color_scale, color_title, data, g_color_group_keys, g_points, g_toggle_names, opacity, plot, point_names, points, radius, redraw, sidebar, toggle_names, toggle_points, transform;
