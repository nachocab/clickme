  ...
  <body>
    ...
    (function() {
      ...
      plot = new_plot({
        ...
        xlim: {{  toJSON(params$xlim ) }},
        ylim: {{  toJSON(params$ylim ) }},
        categorical_domains: {
          x: {{  toJSON(params$x_categorical_domain)  }},
          y: {{  toJSON(params$y_categorical_domain)  }}
        },
      ...
      plot.tooltip_text = function(d) {
        return {{  get_tooltip_content_points(opts$data, params)  }};
      };
      ...
      if (color_scale.range().length > 1) {
        sidebar.append("text").attr({
          ...
          "font-size": "16px",
          "font-weight": "bold"
        }).text({{  toJSON(params$color_title)  }});
